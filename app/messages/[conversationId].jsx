...
export default function ConversationScreen() {
    ...
    const handleNewMessage =
      async (incomingMessage) => {
        ...
        try {
          ...
          console.warn(
            "[E2EE] Socket message decryption failed:",
            getMessageId(
              incomingMessage
            ),
            error?.message ||
  ...
  const handleMediaSelected =
    useCallback(() => {
      Alert.alert(
        "Encrypted media coming soon",
        "Text messages are protected with end-to-end encryption. Encrypted photo and video sending is not enabled yet."
      );
    }, []);
  ...
  const handleVoiceRecorded =
    useCallback(() => {
      Alert.alert(
        "Encrypted voice messages coming soon",
        "Voice-message encryption is not enabled yet, so the recording was not uploaded."
      );
    }, []);
      ...
      >
        ...
        >
          ...
          >
            ...
            !selectedMessage?.decryptionFailed ? (
              <ActionRow
                icon="copy-outline"
                label="Copy"
                onPress={() =>
    ...
    >
      ...
      >
        ...
        {isVoice ? (
          <View
            style={
              styles.encryptedVoicePlaceholder
            }
          >
            <Ionicons
              name="lock-closed-outline"
